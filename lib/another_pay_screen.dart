...
class AnotherPayScreen extends StatelessWidget {
  const AnotherPayScreen({super.key});
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildRow(
                          ...
                          'cairo'),
                      _buildRow(
                          'المصروف الفرعي:مدفوعات اخرى',
                          Color(0xFFECF0F2),
                          40,
                          TextAlign.left,
                          FontWeight.w600,
                          'cairo'),
                      _buildRow('المبلغ المستحق:', Colors.white, 40,
                          TextAlign.right, FontWeight.w600, 'cairo'),
                      _buildRow('حاله الدفع:لم يتم الدفع', Color(0xFFECF0F2), 40,
                          TextAlign.right, FontWeight.w600, 'cairo'),
                      _buildRow('تاريخ الاستحقاق:', Colors.white,
