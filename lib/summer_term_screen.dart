...
class SummerTermScreen extends StatelessWidget {
  const SummerTermScreen({super.key});
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildRow(
                          ...
                          FontWeight.w600,
                          'cairo'),
                      _buildRow('المبلغ المستحق:200', Colors.white, 40,
                          TextAlign.right, FontWeight.w600, 'cairo'),
                      _buildRow('حاله الدفع:لم يتم الدفع', Color(0xFFECF0F2), 40,
                          TextAlign.right, FontWeight.w600, 'cairo'),
                      _buildRow('تاريخ الاستحقاق:16/08/2024', Colors.white,
