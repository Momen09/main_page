...
class BookFeesScreen extends StatelessWidget {
  const BookFeesScreen({super.key});
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildRow('كود أمر الدفع:05454', Color(0xFFECF0F2), 40,
                          TextAlign.left, FontWeight.w600, 'cairo'),
                      _buildRow(
                          'المصروف الفرعي:مصروفات المدينه الجامعيه',
                          Colors.white,
                          40,
                          TextAlign.left,
                          FontWeight.w600,
                          'cairo'),
                      _buildRow('المبلغ المستحقه:1500', Color(0xFFECF0F2), 40,
                          TextAlign.right, FontWeight.w600, 'cairo'),
                      _buildRow('حاله الدفع:لم يتم الدفع', Colors.white, 40,
                          TextAlign.right, FontWeight.w600, 'cairo'),
                      _buildRow('تاريخ الاستحقاق:10/02/2024', Color(0xFFECF0F2),
